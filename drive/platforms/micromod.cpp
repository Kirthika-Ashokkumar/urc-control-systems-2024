...
hardware_map_t initialize_platform()
{
  ...
  //   mc_x_front_left_prop = &temp;
  // } catch (const hal::exception& e) {
  //   hal::print<1028>(terminal, "Exception code flp %d\n", e.error_code());
  // }
  ...
  try {
    ...
    hal::print<1028>(terminal, "Exception code fls %d\n", e.error_code());
  }
  ...
  //   mc_x_front_right_prop = &temp;
  // } catch (const hal::exception& e) {
  //   hal::print<1028>(terminal, "Exception code frp %d\n", e.error_code());
  // }
  ...
  //   mc_x_back_left_prop = &temp;
  // } catch (const hal::exception& e) {
  //   hal::print<1028>(terminal, "Exception code  blp %d\n", e.error_code());
  // }
  ...
  try {
    ...
    hal::print<1028>(terminal, "Exception code bls %d\n", e.error_code());
  }
  ...
  //   mc_x_back_right_prop = &temp;
  // } catch (const hal::exception& e) {
  //   hal::print<1028>(terminal, "Exception code brp %d\n", e.error_code());
  // }
  ...
  try {
    ...
    hal::print<1028>(terminal, "Exception code brs %d\n", e.error_code());
  }
