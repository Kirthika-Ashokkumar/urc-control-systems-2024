...
void science_state_machine::mix_solution([[maybe_unused]] int rotations){
  //:TO-DO
}
...
void science_state_machine::run_state_machine([[maybe_unused]] science_states state)
{
  switch(state){
    ...
    case science_state_machine::science_states::DUMP_SAMPLE: 
      ...
      hal::delay(*m_clock, 1000ms);
      break;
    case science_state_machine::science_states::ADD_MIX_DI_WATER:
    ...
    case science_state_machine::science_states::ADD_MIX_BENEDICT_REAGENT:
      ...
      mix_solution(100);
      break;
    case science_state_machine::science_states::ADD_MIX_BIURET_REAGENT:
      m_carousel->step_move(2);
      ...
      mix_solution(100);
      break;
    case science_state_machine::science_states::ADD_MIX_KALLING_REAGENT:
      m_carousel->step_move(2);
      hal::delay(*m_clock, 200ms);
